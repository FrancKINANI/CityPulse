...
class CreatingAnAccount... extends StatefulWidget {
  ...
  const CreatingAnAccount({super.key});...@override
													...
													child: Container(
														...
														child: Column(
															...
															children: [
																IntrinsicHeight(
																	child: Container(
																		margin: const EdgeInsets.only( bottom: 449),
																		width: double.infinity,
																		child: Column(
																			crossAxisAlignment: CrossAxisAlignment.start,
																			children: [
																						...
																						child: Row(
																							children: [
																								Container(
																									...
																									height: 24,
																									child: Image.network(
																										"https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/13f74378-95ff-4658-a0c2-874c4fa2f813",
																										fit: BoxFit.fill,
																									)
																								),
																								Text(
																											...
																											child: Column(
																												...
																												children: [
																													Container(
																														...
																														width: double.infinity,
																														child: Image.network(
																															"https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/5e5ec741-2ff7-495c-b80e-bb429e956c0e",
																															fit: BoxFit.fill,
																														)
																													),
																													Container(
																											...
																											child: Column(
																												...
																												children: [
																													Container(
																														...
																														width: double.infinity,
																														child: Image.network(
																															"https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/4375f469-23fb-49ff-b3b1-02750a6eaf60",
																															fit: BoxFit.fill,
																														)
																													),
																													Container(
																											...
																											child: Column(
																												...
																												children: [
																													Container(
																														...
																														width: double.infinity,
																														child: Image.network(
																															"https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/d0372cb8-39a8-44fc-b722-39034eefc5cd",
																															fit: BoxFit.fill,
																														)
																													),
																													Container(
