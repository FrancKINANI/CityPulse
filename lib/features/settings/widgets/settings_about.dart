    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          buildInfoRow('Version', appVersion),
          const Divider(),
          buildActionRow(
          ...
          const Divider(),
          buildActionRow('Licences', Icons.file_copy_outlined, onLicenses),
          const Divider(),
          buildActionRow('Aide', Icons.help_outline, onHelp),
        ],
      ),
    );
  }
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          Text(
            label,
            style: TextStyle(fontSize: 16, color: themeService.isDarkMode ? AppTheme.darkTextPrimaryColor : AppTheme.textPrimaryColor),
          ),
          Text(
            value,
            style: TextStyle(
  ...
  Widget buildActionRow(String title, IconData icon, VoidCallback onTap) {
    return InkWell(
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            Icon(icon, size: 24, color: themeService.isDarkMode ? AppTheme.darkTextPrimaryColor : AppTheme.textPrimaryColor),
